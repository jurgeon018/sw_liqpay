    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liqpay_public_key', models.TextField(verbose_name='Публічний ключ')),
                ('liqpay_private_key', models.TextField(verbose_name='Приватний ключ')),
                ('liqpay_sandbox_public_key', models.TextField(verbose_name='Тестовий публічний ключ')),
                ('liqpay_sandbox_private_key', models.TextField(verbose_name='Тестовий приватний ключ')),
                ('sandbox_mode', models.BooleanField(verbose_name='Тестовий режим')),
            ],
            options={
