    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liqpay_public_key', models.TextField(default='i28278182976', verbose_name='Публічний ключ')),
                ('liqpay_private_key', models.TextField(default='ZMvIe9WXCH19g64bvR6dwTMplK1q0950GhkGp3T0', verbose_name='Приватний ключ')),
                ('liqpay_sandbox_public_key', models.TextField(default='sandbox_i60957727413', verbose_name='Тестовий публічний ключ')),
                ('liqpay_sandbox_private_key', models.TextField(default='sandbox_ZC909HGHFAWRTyR0E5nCZkXrkaJZTaLQtCbLu2nr', verbose_name='Тестовий приватний ключ')),
                ('sandbox_mode', models.BooleanField(default=1, verbose_name='Тестовий режим')),
            ],
            options={
